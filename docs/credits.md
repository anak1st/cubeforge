...
## Minecraft 官方资源（`public/textures/` 与 `temp/minecraft-assets/`）

提取自 Mojang 官方客户端 26.2（`client.jar`，经 `scripts/fetch-mc-assets.sh` 从 Mojang 官方 CDN 获取，2026-08-31）。
全量解压在 `temp/minecraft-assets/`（工作区），仅挑选必要的资源落位到 `public/`。逐类分析与挑选清单见 [`docs/assets/minecraft.md`](assets/minecraft.md)。
...
| minetest_game | github.com/luanti-org/minetest_game | 代码 LGPL 2.1+，媒体 CC BY-SA 3.0 | `docs/refs/luanti.md`（§21 附录） |
